                            ...
                            <form action="" class=" form-inline">
                                ...
                                <div style="display: none;" class="search-toggle">
									<div class="search-row">
										<div class="css-1xhj18k" style="display: none;">
											<ul class="css-u7xspg">
												<li value="전체" class="css-197tgoj">전체</li>
												<li value="서울" class="css-197tgoj">서울</li>
												<li value="부산" class="css-197tgoj">부산</li>
												<li value="인천" class="css-197tgoj">인천</li>
												<li value="대구" class="css-197tgoj">대구</li>
												<li value="울산" class="css-197tgoj">울산</li>
												<li value="광주" class="css-197tgoj">광주</li>
												<li value="대전" class="css-197tgoj">대전</li>
												<li value="세종" class="css-197tgoj">세종</li>
											</ul>
											<ul class="css-std6wi">
												<li value="경기" class="css-197tgoj">경기도</li>
												<li value="경남" class="css-197tgoj">경상남도</li>
												<li value="경북" class="css-197tgoj">경상북도</li>
												<li value="전남" class="css-197tgoj">전라남도</li>
												<li value="전북" class="css-197tgoj">전라북도</li>
												<li value="충남" class="css-197tgoj">충청남도</li>
												<li value="충북" class="css-197tgoj">충청북도</li>
												<li value="강원" class="css-197tgoj">강원도</li>
												<li value="제주" class="css-197tgoj">제주도</li>
											</ul>
										</div>
									</div>
                                    <div class="search-row">
										<div class="form-group mar-r-20" style="margin-right: 50px">
											<label for="price-range">카테고리</label><br>
